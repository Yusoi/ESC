	...
	do
		...
		do
			...
			then
				...
				(sleep 1 && vmstat -s) > ../RESULTS/$machine/$ver/$benchmark.$class/vmstat.txt & bin/$benchmark.$class.x > ../RESULTS2/$machine/$ver/$benchmark.$class/output.txt
			else
